          ...
          <Card className="w-full max-w-2xl max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="p-5 space-y-6">
              ...
              <div className="flex gap-3 pt-3 sticky bottom-0 bg-card pb-1">
                {(() => {
                  const action = tenantActions[selected.id];
                  ...
                  return (
                    <>
                      {!isApproved && (
                        <Button variant="hero" className="flex-1 rounded-xl gap-2" onClick={() => handleApprove(selected)}>
                      ...
                      {isApproved && !hasViewing && (
                        <Button
                          variant="outline"
                          className="flex-1 rounded-xl gap-2 border-border"
                      ...
                      {!isApproved && (
                        <Button variant="destructive" className="rounded-xl gap-2" onClick={() => handleReject(selected)}>
